...
export const createProductSchema = z.object({
  body: z.object({
    ...
    hsnCode: z.preprocess(emptyToUndefined, z.string().optional()),
    barcode: z.preprocess(emptyToUndefined, z.string().max(20).optional()),
    barcodeType: z.enum(['EAN13', 'EAN8', 'UPCA', 'CODE128', 'CODE39']).optional(),
  }),
});
