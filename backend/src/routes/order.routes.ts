...
import { canAccessSales, authorize } from '../middleware/role.middleware';
...
router.put('/admin/:id/status', authorize('admin', 'sales', 'logistics'), validate(updateOrderStatusSchema), orderController.updateOrderStatus);
