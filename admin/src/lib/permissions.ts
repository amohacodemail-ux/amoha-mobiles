...
const ROLE_PERMISSIONS: Record<UserRole, Record<Module, Action[]>> = {
  ...
  purchase: {
    // Purchase modules - full access except delete
    [MODULES.DASHBOARD]: [ACTIONS.READ],
    [MODULES.PRODUCTS]: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.EDIT],
    [MODULES.CATEGORIES]: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.EDIT],
    [MODULES.BRANDS]: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.EDIT],
    [MODULES.INVENTORY]: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.EDIT],
    [MODULES.SUPPLIERS]: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.EDIT],
    [MODULES.SUPPLIER_ENTRIES]: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.EDIT],
    [MODULES.RFQ]: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.EDIT],
    [MODULES.PURCHASE_REQUESTS]: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.EDIT],
    [MODULES.REPORTS]: [ACTIONS.READ],
    [MODULES.NOTIFICATIONS]: [ACTIONS.READ],
