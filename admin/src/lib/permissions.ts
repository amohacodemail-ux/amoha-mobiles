...
const ROLE_PERMISSIONS: Record<UserRole, Record<Module, Action[]>> = {
  admin: {
    ...
    [MODULES.PURCHASE_ORDERS]: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.GRN]: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.PURCHASE_RETURNS]: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.PURCHASE_PAYMENTS]: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.PURCHASE_REPORTS]: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.EDIT, ACTIONS.DELETE],
    // Marketing
    ...
    // Logistics
    [MODULES.DELIVERY_MANAGEMENT]: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.EDIT, ACTIONS.DELETE],
  ...
  sales: {
    ...
    [MODULES.GRN]: [],
    [MODULES.PURCHASE_RETURNS]: [],
    [MODULES.PURCHASE_PAYMENTS]: [],
    [MODULES.PURCHASE_REPORTS]: [],
    [MODULES.CAMPAIGNS]: [],
    [MODULES.COUPONS]: [],
    [MODULES.BANNERS]: [],
    [MODULES.REVIEWS]: [],
  ...
  service_engineer: {
    // Service engineers - full access to all modules
    [MODULES.DASHBOARD]: [ACTIONS.READ],
    [MODULES.ORDERS]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.BILLING]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.REPORTS]: [ACTIONS.READ],
    [MODULES.BARCODE_POS]: [ACTIONS.READ, ACTIONS.EDIT],
    [MODULES.RETURNS]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.WALLETS]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.PRODUCTS]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.CATEGORIES]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.BRANDS]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.SERVICE_REQUESTS]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.NOTIFICATIONS]: [ACTIONS.READ, ACTIONS.DELETE],
    [MODULES.POLICIES]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.INVENTORY]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.SUPPLIERS]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.SUPPLIER_ENTRIES]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.RFQ]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.PURCHASE_REQUESTS]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.PURCHASE_ORDERS]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.GRN]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.PURCHASE_RETURNS]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.PURCHASE_PAYMENTS]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.PURCHASE_REPORTS]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.CAMPAIGNS]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.COUPONS]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.BANNERS]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.REVIEWS]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.CONTACT_MESSAGES]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.PRODUCT_VIEWS]: [ACTIONS.READ],
    [MODULES.ABANDONED_CARTS]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.CRM]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.USERS]: [ACTIONS.READ, ACTIONS.EDIT, ACTIONS.DELETE],
    [MODULES.ACTIVITY_LOGS]: [ACTIONS.READ],
