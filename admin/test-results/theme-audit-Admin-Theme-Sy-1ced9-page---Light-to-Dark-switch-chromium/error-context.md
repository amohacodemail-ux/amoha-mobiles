...
- Name: theme-audit.spec.ts >> Admin Theme System Validation >> TEST 1: Light → Dark Theme Switch >> Activity Logs page - Light to Dark switch
- Location: e2e\theme-audit.spec.ts:43:11
...
```ts
  1   | /**
  2   |  * Admin Panel Theme Audit & Dark/Light Mode Validation Tests
  3   |  */
  4   | 
  5   | import { test, expect, Page } from '@playwright/test';
  6   | 
  7   | // Admin pages to test
  8   | const ADMIN_PAGES = [
  9   |   { name: 'Login', path: '/login' },
  10  |   { name: 'Dashboard', path: '/dashboard' },
  11  |   { name: 'Products', path: '/products' },
  12  |   { name: 'Orders', path: '/orders' },
  13  |   { name: 'Users', path: '/users' },
  14  |   { name: 'Categories', path: '/categories' },
  15  |   { name: 'Settings', path: '/settings' },
  16  |   { name: 'Reports', path: '/reports' },
  17  |   { name: 'Barcode POS', path: '/barcode' },
  18  |   { name: 'Inventory', path: '/inventory' },
  19  |   { name: 'CRM', path: '/crm' },
  20  |   { name: 'Reviews', path: '/reviews' },
  21  |   { name: 'Banners', path: '/banners' },
  22  |   { name: 'Coupons', path: '/coupons' },
  23  |   { name: 'Activity Logs', path: '/activity-logs' },
  24  | ];
  25  | 
  26  | /**
