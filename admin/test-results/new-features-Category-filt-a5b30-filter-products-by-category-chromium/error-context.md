...
- Name: new-features.spec.ts >> Category filter in products >> admin can filter products by category
- Location: e2e\new-features.spec.ts:31:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3003/products
Call log:
  - navigating to "http://localhost:3003/products", waiting until "networkidle"
