...
- Name: new-features.spec.ts >> Purchase Requests >> Purchase Requests list page renders
- Location: e2e\new-features.spec.ts:208:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3003/purchase-requests
Call log:
  - navigating to "http://localhost:3003/purchase-requests", waiting until "networkidle"
