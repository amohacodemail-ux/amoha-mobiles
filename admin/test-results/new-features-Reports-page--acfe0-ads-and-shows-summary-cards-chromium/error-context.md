...
- Name: new-features.spec.ts >> Reports page >> reports page loads and shows summary cards
- Location: e2e\new-features.spec.ts:77:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3003/reports
Call log:
  - navigating to "http://localhost:3003/reports", waiting until "networkidle"
