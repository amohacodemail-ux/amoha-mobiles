...
- Name: crm.spec.ts >> CRM page >> CRM detail page shows stats and recent orders section
- Location: e2e\crm.spec.ts:153:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3003/crm
Call log:
  - navigating to "http://localhost:3003/crm", waiting until "networkidle"
