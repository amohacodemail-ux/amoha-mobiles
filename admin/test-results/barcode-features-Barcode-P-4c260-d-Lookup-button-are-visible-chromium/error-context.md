...
- Name: barcode-features.spec.ts >> Barcode Page – Counter Billing tab >> Scanner input and Lookup button are visible
- Location: e2e\barcode-features.spec.ts:56:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3003/barcode
Call log:
  - navigating to "http://localhost:3003/barcode", waiting until "networkidle"
