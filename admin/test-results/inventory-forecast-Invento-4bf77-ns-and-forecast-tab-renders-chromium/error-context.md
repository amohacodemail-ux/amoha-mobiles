...
- Name: inventory-forecast.spec.ts >> Inventory Forecast Page >> loads without client-side exceptions and forecast tab renders
- Location: e2e\inventory-forecast.spec.ts:26:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3003/inventory
Call log:
  - navigating to "http://localhost:3003/inventory", waiting until "networkidle"
