  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/98 backdrop-blur-xl dark:border-white/[0.06] dark:bg-[var(--header-bg)] dark:backdrop-blur-xl">
      ...
      <div className="border-b border-slate-100 bg-slate-50/60 dark:border-white/[0.05] dark:bg-surface/60">
        <div className="page-container flex items-center justify-between py-1.5 text-xs text-slate-500 dark:text-slate-400">
          <span className="truncate text-xs font-medium text-slate-600 dark:text-slate-400 mr-2">{announcement}</span>
          <span className="hidden flex-shrink-0 text-xs font-medium text-slate-600 dark:text-slate-400 sm:inline">Support: {contactPhone}</span>
        </div>
      </div>
