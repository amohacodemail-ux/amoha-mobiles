    ...
    <header className="sticky top-0 z-50 border-b border-gray-200 bg-white/95 backdrop-blur-2xl dark:border-white/5 dark:bg-primary-950/95">
      ...
      <div className="border-b border-gray-100 bg-gray-50/80 dark:border-white/5 dark:bg-primary-950/80">
        <div className="page-container flex items-center justify-between py-1.5 text-xs text-gray-500 dark:text-gray-400">
          <span className="truncate text-xs font-medium text-gray-600 dark:text-gray-400 mr-2">{announcement}</span>
          <span className="hidden flex-shrink-0 text-xs font-medium text-gray-600 dark:text-gray-400 sm:inline">Support: {contactPhone}</span>
        </div>
      </div>
                    ...
                    <>
                      ...
                      <div className="absolute right-0 top-full z-50 mt-2 w-52 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-lg dark:border-white/10 dark:bg-surface-100/95 dark:shadow-glass dark:backdrop-blur-xl">
                        ...
                        <div className="py-1">
                          ...
                          <Link href="/returns" onClick={() => setIsProfileOpen(false)} className="flex items-center gap-2.5 px-3 py-2.5 text-sm text-gray-600 transition-colors hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-white">
                            <HiOutlineRefresh className="h-4 w-4" /> My Returns
                          </Link>
                          <Link href="/wallet" onClick={() => setIsProfileOpen(false)} className="flex items-center gap-2.5 px-3 py-2.5 text-sm text-gray-600 transition-colors hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-white">
